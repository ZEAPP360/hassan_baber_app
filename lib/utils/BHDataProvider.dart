...
List<BHBestSpecialModel> getSpecialList() {
  ...
  list.add(BHBestSpecialModel(title: 'HasBro', subTitle: 'Baber', img: BHdDashedBoardImage5));
  list.add(BHBestSpecialModel(title: 'Meb', subTitle: 'Hire Stylist', img: BHDashedBoardImage1));
...
List<BHSpecialOfferModel> getSpecialOfferList() {
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHdDashedBoardImage5, title: 'HasBro', subtitle: 'Cool Summer Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage3, title: 'Meb ', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage6, title: 'HasBro', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Meb', subtitle: 'Cool Winter Event'));
...
List<BHOfferModel> getOfferList() {
  ...
  offerList.add(
    BHOfferModel(img: BHdDashedBoardImage5, offerName: 'New Hair Style', offerDate: 'June 10 - June 26', offerOldPrice: 100, offerNewPrice: 89),
  );
  offerList.add(
