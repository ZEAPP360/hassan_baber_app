...
import 'package:barberapp/screens/BHBussinessMarketPlace.dart';
...
class BHBussinessDashedBoardScreen extends StatefulWidget {
  // static String tag = '/DashedBoardScreen';

  Map UserData1;
 BHBussinessDashedBoardScreen(this.UserData1);
  


  @override
  BHBussinessDashedBoardScreenState createState() => BHBussinessDashedBoardScreenState(UserData1);

  static void launch(BuildContext context) {}
}

class BHBussinessDashedBoardScreenState extends State<BHBussinessDashedBoardScreen> {
  
  Map UserData1;
 BHBussinessDashedBoardScreenState(this.UserData1);
