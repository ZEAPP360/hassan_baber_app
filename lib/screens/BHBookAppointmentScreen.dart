...
class BHBookAppointmentScreenState extends State<BHBookAppointmentScreen> {
  ...
  var list  = [
    {"name":"HasBro","image":BHdDashedBoardImage5},
    {"name":"Meb","image":BHDashedBoardImage1}
                          ...
                          return Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(list[index]["name"].toString(), style: boldTextStyle(), textAlign: TextAlign.center).paddingOnly(top: 16),
                              ],
                            ),
                          );
                        },
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('Barber shop in St Albans,Uk', style: TextStyle(
                                  fontSize: 10
                                )),
                              ],
                            ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            8.width,
                            Text('Barber shop St Albans,Uk', style: secondaryTextStyle(size: 10)),
                          ],
                        ),
                        16.height,
                        Text('+44 7861 689913', style: boldTextStyle(size: 14)),
                      ],
                    ),
                    8.height,
                    Container(height: 1, width: context.width(), color: BHGreyColor.withOpacity(0.3)),
